...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['owner', 'team-member', 'content-creator', 'social-media-manager', 'end-customer'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Contents', path: '/contents', entity: 'content', service: AccessServiceEnum.PROJECT, icon: FiBox },
    {
    ...
    { name: 'Reminders', path: '/reminders', entity: 'reminder', service: AccessServiceEnum.PROJECT, icon: FiBox },
