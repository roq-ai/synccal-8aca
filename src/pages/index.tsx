  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="SyncCal: Elevating Content Marketing to New Heights. Integrate, Schedule, and Manage Social Media Posts with Reminders and Seamless Instagram API Integration."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1519337265831-281ec6cc8514?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjb250ZW50JTIwbWFya2V0aW5nfGVufDB8fHx8MTY5NTI0MTc0N3ww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`SyncCal: Elevating Content Marketing to New Heights. Integrate, Schedule, and Manage Social Media Posts with Reminders and Seamless Instagram API Integration.`}
            </Text>
            <Box
