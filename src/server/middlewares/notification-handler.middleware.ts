...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'content.create.create': {
    roles: ['owner', 'team-member', 'social-media-manager'],
    key: 'content',
    tenantPath: [],
    userPath: [],
  },
  'campaign.launch.create': {
    roles: ['owner', 'team-member', 'content-creator'],
    key: 'campaign',
    tenantPath: [],
    userPath: [],
  },
  'feedback.submit.create': {
    roles: ['owner', 'team-member', 'content-creator', 'social-media-manager'],
    key: 'feedback',
    tenantPath: [],
    userPath: [],
  },
...
const tenantRoles: string[] = ['owner', 'team-member', 'content-creator', 'social-media-manager', 'end-customer'];
